...
namespace Lese_Ioana_Lab2.Data
{
    public class Lese_Ioana_Lab2Context : DbContext
    {
        ...
        public DbSet<Lese_Ioana_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Lese_Ioana_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Lese_Ioana_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
