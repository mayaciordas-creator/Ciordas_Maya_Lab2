...
builder.Services.AddDbContext<LibraryIdentityContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("Costea_Miriam_Lab2Context") ?? throw new InvalidOperationException("Connection string 'Costea_Miriam_Lab2Context' not found.")));
